import numpy as np
from lenet import convolution, pooling, conv_layer, pool_layer, relu, features_to_network, forward_pass, one_hot, loss
...
correct = one_hot(train_labels[0])
...
print(output)
current_loss = loss(output, correct)
